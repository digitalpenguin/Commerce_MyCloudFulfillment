...
if (!createObject('modNamespace',array(
    'name' => 'commerce_mycloudfulfillment',
    'path' => $componentPath.'/core/components/commerce_mycloudfulfillment/',
    'assets_path' => $componentPath.'/assets/components/commerce_mycloudfulfillment/',
),'name', false)) {
    echo "Error creating namespace commerce_mycloudfulfillment.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mycloudfulfillment.core_path',
    'value' => $componentPath.'/core/components/commerce_mycloudfulfillment/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_mycloudfulfillment',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_mycloudfulfillment.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mycloudfulfillment.assets_path',
    'value' => $componentPath.'/assets/components/commerce_mycloudfulfillment/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_mycloudfulfillment',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_mycloudfulfillment.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_mycloudfulfillment/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mycloudfulfillment.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_mycloudfulfillment',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_mycloudfulfillment.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_mycloudfulfillment.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_mycloudfulfillment',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_mycloudfulfillment.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_mycloudfulfillment/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_mycloudfulfillment/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'DigitalPenguin\\MyCloudFulfillment\\Modules\\', $modulePath);
